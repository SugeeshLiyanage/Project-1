...
$(".submitBtn").on("click", function(event){
 ...
 function ParseLetter(letterValue, position){
        ...
        showPlayer(sentiment.analyze(letterValue)['score']);
    };

function showPlayer(mood){
   ...
   let iframeSrc = "";
    ...
    if( mood >= 0 && mood < 3 ){
        ...
        iframeSrc = "https://open.spotify.com/embed?uri=spotify:user:spotify:playlist:37i9dQZF1DXdPec7aLTmlC";
    }
        ...
        iframeSrc = "https://open.spotify.com/embed?uri=spotify:user:spotify:playlist:37i9dQZF1DX2pSTOxoPbx9";
    }
    
    else if( mood <= 3 && mood > -10 ){
        iframeSrc = "https://open.spotify.com/embed?uri=spotify:user:spotify:playlist:37i9dQZF1DWSqBruwoIXkA";
    }

    else if( mood >= -10 ){
        iframeSrc = "https://open.spotify.com/embed?uri=spotify:user:spotify:playlist:37i9dQZF1DX3YSRoSdA634";
    }
